...
if [ "$1" != "" ]; then
    ...
    echo "usage: ./train_yolov4_cones.sh study_name"
    exit 1
fi
...
WEIGHTS="${DARKNET_DIR}/weights/yolov4.conv.137"
# ----------------------------------------------------
